...
public abstract class Client {
  ...
  public static class ComponentImpl implements Client.Component, Client.Parts {
    ...
    protected void init_gogo() {
      assert this.gogo == null: "This is a bug.";
      this.gogo = this.implementation.make_gogo();
      if (this.gogo == null) {
      	throw new RuntimeException("make_gogo() in composite.Client shall not return null.");
      }
    }
   ...
   * 
   */
  protected abstract Runnable make_gogo();
